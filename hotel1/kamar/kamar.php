...
<div class="container1">
        ...
        <div class="box">
        <h3 style="color: #ffc451">Tambahkan Data Kamar</h3><br>
        <form method="POST" action="input-aksi-kamar.php" style="text-align: left;" style="border: 1px solid #151515;" class="inputan">
        <table>
        <tr>
            <td style="color: #fff">ID Kamar</td>
            <td><input type="number" name="idkmr"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="tipekmr"></td>
        </tr>
        <tr>
            <td style="color: #fff">Harga Per Malam</td>
            <td><input type="text" name="hargapr"></td>
        </tr>
        <tr>
