...
<div class="container1">
        ...
        <div class="isi">
            <table border="1" style="text-align: center;">
                <tr style="border: 1px solid #151515;">
                    <td style="background-color: #ffc451" style="color: #151515;">ID Reservasi</td>
                    <td style="background-color: #ffc451" style="color: #151515;">Nama Tamu</td>
                    ...
                    <td style="background-color: #ffc451" style="color: #151515;">Total Harga</td>
                    <td style="background-color: #ffc451" style="color: #151515;">Nama Karyawan</td>
                    <td style="background-color: #ffc451" style="color: #151515;">Aksi</td>
                </tr>
                <p>.</p>
                <h2>Data Reservasi Hotel</h2><br>
                <?php
                ...
                ?>
                    <tr>
                        <td style="color: #fff;"><?php echo $d['id_reservasi'] ?></td>
                        <td style="color: #fff;"><?php echo $d['nama_tamu'] ?></td>
                        ...
                        <td style="color: #fff;"><?php echo $d['total_harga'] ?></td>
                        <td style="color: #fff;"><?php echo $d['nama_karyawan'] ?></td>
                        <td>
                            <a style="color: #ffc451;" href="hapus-reservasi.php?id=<?php echo $d['id_reservasi']; ?>">Hapus</a>
                            <a style="color: #151515;">.</a>
                            <a style="color: #ffc451;" href="edit-reservasi.php?id=<?php echo $d['id_reservasi']; ?>">Edit</a>
                        </td>
                    </tr>
                <?php
                }
        ...
        <div class="overlay" id="overlay">
            <div class="box">
                <h3 style="color: #ffc451">Tambahkan Data Reservasi</h3><br>
                <form method="POST" action="input-aksi-reservasi.php">
                    <table border="1" style="text-align: left;" style="border: 1px solid #151515;" class="inputan">
                        <tr>
                            <td style="color: #fff">ID Reservasi</td>
                            <td><input type="number" name="idrsr"></td>
                        </tr>
                        <tr>
                            <td style="color: #fff">Nama Tamu</td>
                            <td><input type="text" name="nmtmu"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="cot"></td>
                        </tr>
                        <tr>
                            <td style="color: #fff">Total Harga</td>
                            <td><input type="text" name="toha"></td>
                        </tr>
                        <tr>
                            <td style="color: #fff">Nama Karyawan</td>
                            <td><input type="text" name="nmkry"></td>
                        </tr>
                    </table><br>
                    <div>
