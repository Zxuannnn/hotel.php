...
<body>
    <div class="container1">
        ...
        <div class="overlay" id="overlay">
            <div class="box">
                <h3 style="color: #ffc451">Edit Data Reservasi</h3><br>
                <?php
                include 'koneksih.php';
                $id= $_GET['id'];
                ...
                <form method="POST" action="edit-aksi-reservasi.php">
                    <table style="text-align: left;" style="border: 1px solid #151515;" class="inputan">
                        <tr>
                ...
                <a href="reservasi.php" id="hide-box">Cancel</a>
                <?php    
                }
                ?>
            </div>
