...
<header>
    ...
    <div class="overlay" id="overlay">
        <div class="box">
            <h3 style="color: #ffc451"> Edit Data Karyawan </h3><br>
            <?php
            include 'koneksih.php';
            $id= $_GET['id'];
            ...
            <table style="text-align: left;" style="border: 1px solid #151515;">
                <tr>
                    ...
                    <td>
                        <input type="number" name="id_karyawan" value="<?php echo $tampil['id_karyawan']; ?>"></input>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" name="pekerjaan" value="<?php echo $tampil['pekerjaan']; ?>"></input>
                    </td>
                </tr>
            <table><br>
                <div>
            ...
            <a href="karyawan.php" id="hide-box">Cancel</a>
            <?php    
            }
            ?>
        </div>
